...
function setupCharacters(characters) {
    $.each(characters, function(index, char){
        ...
        setTimeout(function(){
            $('#char-'+char.cid).html('<div class="user"></div><span id="slot-name">'+char.charinfo.firstname+' '+char.charinfo.lastname+'<span id="cid">' + char.citizenid + '</span></span>');
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $("#info-text").html('<i class="fa-solid fa-info"></i>');
            $("#delete-text").html('<i class="fas fa-window-close"></i>');
            $("#play").css({"display":"block"});
